...
//
// Adapted from Zed (https://github.com/zed-industries/zed), `workspace` and
// `theme` crates, Copyright (C) Zed Industries, Inc., GPL-3.0-or-later.

use gpui::{
    App, Bounds, BoxShadow, CursorStyle, Decorations, Global, Hitbox, HitboxBehavior,
...
pub fn client_side_decorations(
    ...
    div()
        ...
        .map(|div| match decorations {
            ...
            Decorations::Client { .. } => rounded_corners(div, tiling)
...
fn rounded_corners<E: Styled>(mut el: E, tiling: Tiling) -> E {
