...
use crate::sqlite::models::{GameEntryRow, GameRow, NewGameEntryRow, NewGameRow};
use anyhow::Result;
use application::domain::game::{GameEntryId, GameId, GameListEntry, GameRepository, NewGame};
use diesel::{
...
impl GameRepository for SqliteStorage {
    ...
    fn count(&self) -> Result<usize> {
        use crate::sqlite::schema::game_entries::dsl as entry_dsl;
    ...
    fn list(&self, offset: usize, limit: usize) -> Result<Vec<GameListEntry>> {
        use crate::sqlite::schema::game_entries::dsl as entry_dsl;
        use crate::sqlite::schema::games::dsl as game_dsl;
